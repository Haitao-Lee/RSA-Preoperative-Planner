...
"}"));
        ...
        matchingCubes_sb = new QSpinBox(groupBox_6);
        matchingCubes_sb->setObjectName(QStringLiteral("matchingCubes_sb"));
        sizePolicy1.setHeightForWidth(matchingCubes_sb->sizePolicy().hasHeightForWidth());
        matchingCubes_sb->setSizePolicy(sizePolicy1);
        matchingCubes_sb->setMinimumSize(QSize(120, 60));
        matchingCubes_sb->setMaximumSize(QSize(120, 16777215));
        QFont font8;
        font8.setFamily(QStringLiteral("Arial"));
        font8.setPointSize(18);
        font8.setBold(true);
        font8.setWeight(75);
        matchingCubes_sb->setFont(font8);

        gridLayout_2->addWidget(matchingCubes_sb, 0, 1, 1, 1);

        threshold_sb = new QSpinBox(groupBox_6);
        threshold_sb->setObjectName(QStringLiteral("threshold_sb"));
        threshold_sb->setMinimumSize(QSize(120, 60));
        threshold_sb->setMaximumSize(QSize(120, 16777215));
        threshold_sb->setFont(font8);

        gridLayout_2->addWidget(threshold_sb, 1, 1, 1, 1);
